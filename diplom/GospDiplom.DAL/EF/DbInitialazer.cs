   ...
   public class DbInitialazer : DropCreateDatabaseIfModelChanges/*DropCreateDatabaseAlways*/<GospContext>
    {
        protected override void Seed(GospContext db)
        {
            ...
            db.Indications.AddRange(new List<Indication>
            {
                ...
                new Indication{Tarif1=1.5, Tarif2=3.5, Month=DateTime.Now, SchetchikId=2 },
                new Indication{Tarif1=4.5, Tarif2=5.5, Month=DateTime.Now, SchetchikId=3 },
                new Indication{Tarif1=6.5, Tarif2=7.5, Month=DateTime.Now, SchetchikId=4 },
                new Indication{Tarif1=8.5, Tarif2=9.5, Month=DateTime.Now, SchetchikId=5 },
                new Indication{Tarif1=10.5, Tarif2=12.5, Month=DateTime.Now, SchetchikId=6 },
                new Indication{Tarif1=14.5, Tarif2=15.5, Month=DateTime.Now, SchetchikId=7 }
            });
